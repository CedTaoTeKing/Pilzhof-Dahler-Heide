            ...
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <div className="flex flex-col md:flex-row gap-12">
                    <div className="md:w-1/2">
                        ...
                        <p className="mt-4 text-forest/60 text-sm uppercase tracking-widest">{recipe.time}</p>
                    </div>
                    <div className="md:w-1/2">
                        <h1 className="text-4xl md:text-5xl font-serif text-forest mb-6">{recipe.title}</h1>
                        <p className="text-xl text-forest/80 font-light leading-relaxed mb-8">
                            {recipe.description}
                        </p>
